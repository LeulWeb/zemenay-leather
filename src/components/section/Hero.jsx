    ...
    <div className="w-screen h-screen bg-hero-background bg-cover flex flex-col items-center justify-center text-white">
      ...
      <section className="flex items-center justify-between w-10/12 mx-auto">
        ...
        <div className="flex items-center space-x-5">
          <Typography variant="lead" className="max-w-64 justify-end">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita,
            incidunt qui quas ex quisquam voluptates aperiam veniam veritatis
            consectetur animi a d?
          </Typography>
          <div className="flex-grow"></div>
          {/* Icons */}
      ...
      <div className="flex justify-between items-end my-5 w-10/12">
        <div>
          ...
          <Typography variant="lead" className="py-5 font-extralight text-3xl">
            251908883884/67
          </Typography>
        </div>
